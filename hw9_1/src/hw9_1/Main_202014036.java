...
public class Main_202014036 {
	public static void main(String[] args) {
		...
		// 선택한 물건 출력하기.
		System.out.print("선택한 물건 = ");
		for (int i = 0; i < n; i++) {
			if (select[i] == 1) { 	/* 	배열 select에서 저장된 순서대로 선택된 물건을 출력. 바로 위 while문에서 물건을 선택하게 되면 1로 저장했기 때문에
										select배열이 1이면 출력하도록 함.*/
